    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="container mt-6">
            ...
            <form method="POST" action="#">
                ...
                <input name="name" type="text" class="form-control @error('name') border-red-500 @enderror"/>
                @error('name')
                    <p class="text-red-500">{{ $message }}</p>
                @enderror

                <label for="exampleFormControlTextarea1">Введите вашу фамилию</label>
                <input name="last_name" type="text" class="form-control @error('last_name') border-red-500 @enderror"/>
                @error('last_name')
                    <p class="text-red-500">{{ $message }}</p>
                @enderror
                ...
                <textarea name="request" class="form-control @error('email') border-red-500 @enderror" id="exampleFormControlTextarea1" rows="10"></textarea>
                @error('email')
                <p class="text-red-500">{{ $message }}</p>
                @enderror
